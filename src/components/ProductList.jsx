...
import SearchBar from "./SearchBar"; // ✅ Import is fine
...
const ProductList = () => {
  ...
  const { paginatedItems, page, setPage, totalItems } =
    usePaginatedProducts(data);
              ...
              <Row xs={1} md={2} lg={4} className="g-3">
                {paginatedItems.length > 0 ? (
                  ...
                  <Col className="text-center">
                    <p className="lead fs-4 text-muted py-4">
                      No results found
                    </p>
                  </Col>
                )}
